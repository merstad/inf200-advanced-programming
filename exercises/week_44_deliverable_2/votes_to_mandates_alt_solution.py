...
This alternative solution stores the number of mandates in the ScoringEntry class.
...
def district_mandates(voting_data, num_mandates):
    ...
    # Distribute mandates
    for _ in range(num_district_mandates):
        ...
        winner.assign_mandate()

    # extract and return results
    return {sd.party: sd.mandates for sd in scoring_data}
